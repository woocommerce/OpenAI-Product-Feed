...
class AdminController
{
    ...
    public function init(): void
    {
        ...
        add_filter('woocommerce_settings_tabs_array', [$this, 'addWcSettingsTab'], 50);
        add_action('woocommerce_settings_tabs_oapfw', [$this, 'renderWcSettingsTab']);
        add_action('woocommerce_update_options_oapfw', [$this, 'saveWcSettings']);

        // Admin post handlers for actions
        add_action('admin_post_oapfw_download_feed', [$this, 'handleDownloadFeed']);
        ...
        add_action('woocommerce_update_product', [$this, 'queueDeltaPush'], 10, 1);
        add_action('woocommerce_product_set_stock', [$this, 'queueDeltaPush'], 10, 1);
        add_action('woocommerce_admin_process_product_object', [$this, 'maybePushDeltaOnSave']);
    ...
    private function renderPushSection(): void
    {
        ...
        printf('<label><input type="checkbox" name="oapfw_settings[delivery_enabled]" value="true" %s/> %s</label>', 
        ...
        printf('<input type="url" class="regular-text" name="oapfw_settings[endpoint_url]" value="%s" placeholder="https://api.openai.com/v1/your-endpoint">', 
        ...
        printf('<input type="text" class="regular-text" name="oapfw_settings[auth_token]" value="%s" placeholder="sk_live_...">', 
