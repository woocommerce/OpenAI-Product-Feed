 ...
 * Instead, all the classes in the OAPFW\\ namespace can be resolved
...
class RuntimeContainer {
	/**
	 * The root namespace of all OAPFW classes in the `includes` directory.
	 *
	 * @var string
	 */
	const NAMESPACE = 'OAPFW\\';
	 ...
	 *
	 * - $class_name is outside the OAPFW root namespace (and wasn't included in the initial resolve cache).
	...
	protected function is_class_allowed( string $class_name ): bool {
        return 0 === strpos( $class_name, self::NAMESPACE);
	}
}
